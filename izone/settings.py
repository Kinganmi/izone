...
# 配置数据库
MYSQL_HOST = os.getenv('IZONE_MYSQL_HOST', '192.168.123.7')
MYSQL_NAME = os.getenv('IZONE_MYSQL_NAME', 'my_izone')
MYSQL_USER = os.getenv('IZONE_MYSQL_USER', 'root')
MYSQL_PASSWORD = os.getenv('IZONE_MYSQL_PASSWORD', 'Abcd@1234')
...
REDIS_HOST = os.getenv('IZONE_REDIS_HOST', '192.168.123.7')
